...
import me.yokeyword.ntdhoang.demo_zhihu.adapter.holder.HeroHolder;
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                for (Hero hero : mData) {
                    if (hero.getName().toLowerCase().contains(lowerConstr) || hero.getName().toLowerCase().contains(lowerConstr)) {
